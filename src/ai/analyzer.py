"""Anthropic analyzer with type dispatch. @phase R160-spectra-3c-hotfix3"""
...
REQUIRED_FIELDS: dict[str, set[str]] = {
    ...
    "tga": {"summary", "stages_interpretation", "overall_confidence"},
    "dsc": {"summary", "thermal_events", "overall_confidence"},
    "ocp": {"summary", "stability_assessment", "overall_confidence"},
}
...
def analyze(parsed: dict[str, Any], metadata: dict[str, Any], locale: str) -> dict[str, Any]:
    ...
    logger.info(
        "AI analyze: type=%s, locale=%s, model=%s",
        spectrum_type, locale, settings.anthropic_model,
    )
    ...
    required = REQUIRED_FIELDS.get(spectrum_type, {"summary", "overall_confidence"})
